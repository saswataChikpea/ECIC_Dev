...
export default class MultiSelectComboBox extends LightningElement {
    ...
    connectedCallback() {
        ...
        console.log("selectedValues", this.selectedValues, Boolean(this.selectedValues));
        var values = this.selectedValues ? this.selectedValues.split(";") : []//(JSON.parse(JSON.stringify(this.selectedValues))) : null;
        if (value || values) {
            var searchString;
            var count = 0;
