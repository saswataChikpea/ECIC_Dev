...
export default class CustomComboboxAutocomplete extends LightningElement {
    ...
    handleSelectOption(event) {
        console.log("#***handleSelectOption value=", JSON.stringify(event.currentTarget.dataset.value))
        console.log("#***handleSelectOption label=", JSON.stringify(event.currentTarget.dataset.label))
        this.value = event.currentTarget.dataset.label;
        //this.label = event.currentTarget.dataset.label;
