...
export default class InitiateNfcFromProposal extends NavigationMixin(LightningElement) {
    @api recordId;
    @track isLoading;
    @api 
    invoke(){
        this.isLoading=true;
        //alert('Invoke called!!!');
        console.log('Inside InitiateNfcFromProposal Invoke recordId:' +this.recordId);
        this.fetchNFC();
